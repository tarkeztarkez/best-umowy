...
function StudentList() {
  ...
  const setWholeState = useDataStore((state) => state.setWholeState);
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {debugMode && (
        <div className="mb-4">
          <Label htmlFor="import-json">Import pełnego stanu (JSON)</Label>
          <textarea
            id="import-json"
            value={importJson}
          ...
          />
          <div className="mt-2">
            <Button onClick={() => setWholeState(importJson)}>
              Załaduj stan
            </Button>
          </div>
        </div>
